								...
								<div class="card">
									<div class="card-header">
										<h3 class="h6 text-uppercase mb-0">
											...
											<a href="{{ url('administrator/manage/municipal/heads') }}" class="float-right btn btn-sm btn-rounded btn-info">Manage Municipal Heads</a>
										</h3>
									</div>
									<div class="card-body">
										<form method="POST" id="municipal-head-form" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-4 form-group {{ ($errors->has('phone')) ? 'has-error' : '' }}">
													...
													<input type="number" name="phone" id="phone" placeholder="0897645321" class="form-control" min="0" value="{{ old('phone') }}">
													@if ($errors->has('phone'))
									...
									<div class="card-body">
										<form method="POST" id="update-municipal-head" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-4 form-group {{ ($errors->has('phone')) ? 'has-error' : '' }}">
													<label class="form-control-label">Phone</label>
													<input type="number" name="phone" id="phone" placeholder="0897645321" class="form-control" min="0" value="{{ $edit->phone }}">
													@if ($errors->has('phone'))
														<strong class="help-block">{{ $errors->first('phone') }}</strong>
													@endif
												</div>
