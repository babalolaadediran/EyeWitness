					...
					<div class="row">
                        ...
                        <div class="col-md-8 mb-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ url('administrator/update/profile') }}" id="update-profile" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-7 form-group {{ ($errors->has('fullname')) ? 'has-error' : '' }}">
                                                <label class="form-control-label">Fullname</label>
                                                <input type="text" name="fullname" id="fullname" placeholder="Fullname" class="form-control" value="{{ $admin->fullname }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 form-group {{ ($errors->has('dob')) ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="dob" id="dob" placeholder="Date Of Birth" class="form-control datepicker" value="{{ $admin->dob }}">
                                                @if ($errors->has('dob'))
                                            ...
                                            <div class="col-md-7 form-group {{ ($errors->has('phone')) ? 'has-error' : '' }}">
                                                ...
                                                <input type="number" name="phone" id="phone" placeholder="XXXXXXXXXX" class="form-control" min="0" value="{{ $admin->phone }}">
                                                @if ($errors->has('phone'))
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group {{ ($errors->has('email')) ? 'has-error' : '' }}">
                                                ...
                                                <input type="email" name="email" id="email" placeholder="name@domain.com" class="form-control" value="{{ $admin->email }}">
                                                @if ($errors->has('email'))
                                            ...
                                            <div class="col-md-6 form-group {{ ($errors->has('address')) ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="address" id="address" placeholder="Address" class="form-control" value="{{ $admin->address }}">
                        ...
                        <div class="col-md-4 mb-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ url('administrator/update/password') }}" id="update-password">
                                        @csrf
                                        <div class="row">
