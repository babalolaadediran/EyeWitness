								...
								<div class="card">
									...
									<div class="card-body">
										<form method="POST" id="agency-form">
                                            ...
                                            <div class="form-group {{ ($errors->has('agency_name')) ? 'has-error' : '' }}">
												<label class="form-control-label">Agency Name</label>
												<input type="text" name="agency_name" id="agency_name" placeholder="Police Force" class="form-control" value="{{ $edit->agency_name }}">
											</div>
											<div class="form-group {{ ($errors->has('description')) ? 'has-error' : '' }}">
												<label class="form-control-label">Description</label>
										  	...
										  	<tbody>
												@foreach ($agencies as $agency)
													<tr>
														...
														<td>
															<a href="{{ url('district/edit/agency/'.$agency->id) }}" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
        ...
        $('body').on('click', '.delete', function(){
            ...
            swal({
                ...
                if(willDelete){
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ url('district/delete/agency') }}",
                        data:{id:id},
