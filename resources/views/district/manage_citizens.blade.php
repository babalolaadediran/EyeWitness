							...
							<div class="card">
								<div class="card-header">
									<h6 class="text-uppercase mb-0">
										Manage Citizens
										<a href="{{ url('district/citizen') }}" class="float-right btn btn-sm btn-rounded btn-info">New Citizen</a>
									</h6>
								</div>
								<div class="card-body">
											...
											<tbody>
												@foreach ($citizens as $citizen)
													<tr>
														...
														<th><img src="data:image/png;base64,{{ $citizen->picture }}" alt="District Head Image" class="avatar"></th>
														...
														<td>
															<a href="{{ url('district/edit/citizen/'.$citizen->id) }}" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
        ...
        $('body').on('click', '.delete', function(){
            ...
            swal({
                ...
                if(willDelete){
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ url('district/delete/citizen') }}",
                        data:{id:id},
